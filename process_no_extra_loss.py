...
def train(train_loader, model, criterion, optimizer, lr_scheduler, epoch, monitors, args):
    ...
    model.train()
    # model.module.features[ 1].eval()
    # model.module.features[ 4].eval()
    # model.module.features[ 8].eval()
    # model.module.features[15].eval()
    # model.module.features[21].eval()
    # model.module.features[25].eval()
    # model.module.features[31].eval()
    # model.module.features[35].eval()
    # model.module.features[41].eval()  
    # for i in range(0,44):
    #     print(model.module.features[i])
    #     print("Training=")
    #     print(model.module.features[i].training)
        ...
        if (batch_idx + 1) % args.log.print_freq == 0:
            for m in monitors:
                m.update(epoch, batch_idx + 1, steps_per_epoch, 'Training', {
                    ...
                    #'LRG2': optimizer.param_groups[2]['lr']
                })
