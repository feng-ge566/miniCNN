...
from quan.quant_sparse_layers import QuanSparseConv2dSRP_feng,QuanSparseLinearSRP_feng,Quanconv2_feng,QuanLinear_feng
...
class VGG(nn.Module):
    ...
    def __init__(
        ...
        self.classifier = nn.Sequential(
            ...
            QuanLinear_feng(in_features=256 * 8 * 8, out_features=256, 
                             sparsity=vs[0], 
            ...
            QuanLinear_feng(in_features=256, out_features=128, 
                             sparsity=vs[1],
    ...
    def calculate_complexity(self):
        total = 0
        for m in self.modules():
            if isinstance(m,QuanLinear_feng) or isinstance(m,Quanconv2_feng):
...
kbs_cfgs: Dict[str, List[Union[str, int]]] = {
    ...
    'F': [[ 64,8,8,0.00,16,1], [64,8,8,0.00,16,1], 'M', [128,8,8,0.00,16,1], [256,8,8,0.00,16,1], [256,8,8,0.00,16,1],'M'],
}
